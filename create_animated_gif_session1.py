...
if __name__ == "__main__":
    ...
    # First build session date and user perspective
    patterns = ["snapshot_20260315", "user_perspective"]
    output_filename = os.path.join(folder, "timelapse_20260315_user_perspective.gif")

    # Using 500ms duration for fewer frames to make it readable
    create_gif(folder, output_filename, patterns, duration=500)
