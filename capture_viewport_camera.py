...
if rv3d:
    # Use User_Perspective_Camera as the name
    cam_name = "User_Perspective_Camera"
    ...
    # Adjust camera properties if needed
    cam_obj.data.lens = 50 # Default lens
    
    # Output success
    print(f"SUCCESS: Created/Updated '{cam_name}' from viewport.")
